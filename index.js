...
import { getFirestore, collection, query, where, orderBy, limit, getDocs, addDoc, serverTimestamp, onSnapshot } from 'https://www.gstatic.com/firebasejs/10.12.5/firebase-firestore.js';
...
function updateCounter() {
    ...
    counterText.textContent = `${len}/200`;
...
async function loadPresenters() {
    ...
    const qy = query(presentersCol, where('dateKey', '>=', todayKey), orderBy('dateKey', 'asc'), limit(100));
